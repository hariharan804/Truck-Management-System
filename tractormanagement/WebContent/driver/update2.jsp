...
<meta http-equiv="refresh"
	content="1; URL=http://localhost:8080/tractormanagement/Driver.jsp" />
...
PreparedStatement ps = con.prepareStatement("update tmsd set name=?, number=?, email=?, exp=?, dob=? where id=?");
