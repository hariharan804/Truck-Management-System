...
<body>
	<center>
		...
		<div class="tms">
			...
			<form action="http://localhost:8080/tractormanagement/driver/add.jsp">
				<p>
					Driver Name<input type="text" name="name"
						placeholder="Enter Driver Name" required> <br /> Ph Number<input
						type="text" name="num" placeholder="Enter ph Number" required><br />
					Email Id<input type="text" name="email"
						placeholder="Enter Email Id" required><br /> Driver
					Experience<input type="text" name="exp"
						placeholder="Enter Experience" required><br /> DOB<input
						type="text" name="dob" placeholder="Enter DOB" required><br />
				</p>
